<template><Layout title='Case' description='case is used to change stored value based on some condition.' keywords='case, query, indexeddb, jsstore' contentSrc='/home/warrior/projects/opensource/doc-template/content/tutorial/case.md'><p>case is an option in select query which is used to change stored value based on some condition. It is similar to multiple if else statetement. So once a condition is true it is stopped and value is returned.</p>
