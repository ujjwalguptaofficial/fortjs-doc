<template><Layout title='Join' description='learn how to use join in indexedb using jsstore' keywords='indexeddb, join, left, inner, jsstore' contentSrc='/home/warrior/projects/opensource/doc-template/content/tutorial/select/join.md'><p>JsStore supports two joins - Inner &amp; Left.</p>
