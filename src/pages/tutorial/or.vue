<template><Layout title='Or' description='learn how to use or to filter records in indexeddb' keywords='or, api, query, indexeddb, jsstore' contentSrc='/home/warrior/projects/opensource/doc-template/content/tutorial/or.md'><p>Or can be used with Where to filter records.</p>
<h4 id="sql">Sql</h4>
