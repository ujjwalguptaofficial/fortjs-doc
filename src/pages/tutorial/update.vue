<template><Layout title='Update' description='learn how to update data in indexedb using jsstore' keywords='update, api, query, indexeddb, jsstore' contentSrc='/home/warrior/projects/opensource/doc-template/content/tutorial/update.md'><p>Update is used to modify the existing records in a table. You can use Where to filter records.</p>
<h4 id="sql">Sql</h4>
