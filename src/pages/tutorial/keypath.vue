<template><Layout title='keyPath' description='learn how to use keypath for querying faster in indexeddb' keywords='keypath, column, indexing, indexeddb, jsstore' contentSrc='/home/warrior/projects/opensource/doc-template/content/tutorial/keypath.md'><p>keyPath is a option in column. It is used to add multiple index, so that query execution can be made faster. It takes an array of type string.</p>
