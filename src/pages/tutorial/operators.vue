<template><Layout title='Operators' description='list of operators available and their uses' keywords='operators, >, <, indexeddb, jsstore' contentSrc='/home/warrior/projects/opensource/doc-template/content/tutorial/operators.md'><p>JsStore supports following operators : -</p>
<ul>
<li><strong>" &gt; " :</strong> Finds value greater than supplied value.</li>
<li><strong>" &lt; " :</strong> Finds value less than supplied value.</li>
