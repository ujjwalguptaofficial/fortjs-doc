<template><Layout title='Multi Entry' description='MultiEntry allows you to query array value in a column.' keywords='multi entry, option, column, indexeddb, jsstore' contentSrc='/home/warrior/projects/opensource/doc-template/content/tutorial/multi-entry.md'><p>consider these values in a table</p>
<pre><code>var values = [
    {
        name: "Ray",
