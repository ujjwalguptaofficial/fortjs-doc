<template><Layout title='Components' description='Description about components of fortjs' keywords='components, modularize, app, fortjs, node' contentSrc='/home/warrior/projects/opensource/fortjs.docs/content/tutorial/components.md'><p>Components are most important part of fort application. They are independent &amp; every component has its own lifecycle and scope. It helps you to modularize your app &amp; reutilize codes.</p>
