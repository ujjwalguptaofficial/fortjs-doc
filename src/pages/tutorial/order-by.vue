<template><Layout title='Order By' description='learn how to use order data in indexeddb' keywords='order by, sort by, select, indexeddb, jsstore' contentSrc='/home/warrior/projects/opensource/doc-template/content/tutorial/order-by.md'><p>Order By is used to sort the data in ascending or descending order, based on any column.</p>
<h4 id="sql">Sql</h4>
