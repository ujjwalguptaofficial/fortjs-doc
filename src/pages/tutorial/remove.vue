<template><Layout title='Delete' description='remove data from a table in indexeddb' keywords='remove, delete, api, indexeddb, jsstore' contentSrc='/home/warrior/projects/opensource/doc-template/content/tutorial/remove.md'><p>You can use Where to filter results.</p>
<h4 id="sql">Sql</h4>
