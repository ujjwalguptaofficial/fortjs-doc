<template><Layout title='Connection' description='How to create connection in jsstore' keywords='database, connection, query, indexeddb, jsstore' contentSrc='/home/warrior/projects/opensource/doc-template/content/tutorial/connection.md'><p>Connection in jsstore is instance of class <code>Connection</code>. All apis are called using connection.</p>
...
<p><strong>example</strong> - <a target="_blank" href="https://github.com/ujjwalguptaofficial/jsstore-examples/tree/master/without_web_worker">https://github.com/ujjwalguptaofficial/jsstore-examples/tree/master/without_web_worker</a></p>
...
<li><p>Create a file jsstore_con.js or jsstore_con.ts (for typescript). This file will be used to create the jsstore connection. You can choose any file name.</p></li>
