<template><Layout title='Data' description='How to pass & access components data' keywords='data, components, options, fortjs, node' contentSrc='/home/warrior/projects/opensource/fortjs.docs/content/tutorial/concepts/data.md'><p><code>data</code> is class member of Wall, Guard , Shield and Controller. It is used to transfer data from one component to another and finally to worker.</p>
