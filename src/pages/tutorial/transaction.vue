<template><Layout title='Transaction' description='learn how to use transaction in jsstore' keywords='transaction, api, query, indexeddb, jsstore' contentSrc='/home/warrior/projects/opensource/doc-template/content/tutorial/transaction.md'><p>IndexedDB is a pure transactional database which means all the query is executed using the transaction.</p>
