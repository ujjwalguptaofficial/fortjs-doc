<template><Layout title='Migrating from v2 to v3' description='migrating from v2 to v3' keywords='migrate, v2, v3, indexeddb, jsstore' contentSrc='/home/warrior/projects/opensource/doc-template/content/tutorial/v2-to-v3.md'><p>Migrating from V2 to V3 is very easy - You just need to change the db schema as per v3.</p>
