<template><Layout title='GraphQl' description='How to use graphql in node using fortjs' keywords='graphql, integrate, fortjs, node' contentSrc='/home/warrior/projects/opensource/fortjs.docs/content/tutorial/graphql.md'><p>FortJs provides a seperate package - <a href="https://github.com/ujjwalguptaofficial/fortjs-graphql">fort-graphql</a> for integration of graphql.</p>
<h2 id="uses">Uses</h2>
<ol>
