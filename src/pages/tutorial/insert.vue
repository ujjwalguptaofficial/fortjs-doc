<template><Layout title='Insert' description='insert data in indexedb' keywords='insert, api, upsert, indexeddb, jsstore' contentSrc='/home/warrior/projects/opensource/doc-template/content/tutorial/insert.md'><p>The Insert api is used to insert new records in a table.</p>
<h4 id="sql">Sql</h4>
